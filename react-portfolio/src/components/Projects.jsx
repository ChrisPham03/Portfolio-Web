...
const Projects = () => {
    const projectsData = [
         ...
         { title: "Analytics Dashboard", description: "Clean and modern dashboard design for data visualization...", image: "/images/Quick.png", tags: ["Web UI", "React", "Data Viz", "Charts"], liveUrl: "https://example.com", githubUrl: "https://github.com" },
